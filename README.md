...
| 类别 | 命令 |
|------|------|
| 📋 访谈管理 | `create`, `update`, `delete`, `publish`, `share`, `get`, `list`, `stats`, `outline` |
| 📝 题目管理 | `add`, `update`, `delete`, `add-section`, `delete-section`, `reorder`, `reorder-sections` |
